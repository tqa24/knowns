...
func TestValidateTask_NoTitle(t *testing.T) {
	...
	issues := validateTask(task, map[string]bool{"abc123": true}, nil, nil, Options{})
...
func TestValidateTask_BrokenParentRef(t *testing.T) {
	...
	issues := validateTask(task, map[string]bool{"abc123": true}, nil, map[string]string{"abc123": "nonexist"}, Options{})
...
func TestValidateTask_CircularParent(t *testing.T) {
	...
	issues := validateTask(task, taskIDs, nil, parentMap, Options{})
...
func TestValidateTask_FulfillsWithSpec(t *testing.T) {
	...
	issues := validateTask(task, map[string]bool{"abc123": true}, docPaths, nil, Options{})
...
func TestValidateTask_ValidInlineRefs(t *testing.T) {
	...
	issues := validateTask(task, taskIDs, docPaths, nil, Options{})
...
func TestValidateTask_SDD_NoAC(t *testing.T) {
	...
	docPaths := map[string]bool{"specs/auth": true}
	issues := validateTask(task, map[string]bool{"abc123": true}, docPaths, nil, Options{Scope: "sdd"})
...
func TestValidateDoc_NoTitle(t *testing.T) {
	...
	issues := validateDoc(doc, nil, nil)
